...
<div class="profile"><label><input type="email" name="email" class="txtb <?php
...
<div class="profile"><label><input type="text" name="user" class="txtb <?php
...
<div class="profile"><label><input type="text" name="phone" class="txtb <?php
...
echo $_SESSION['phone'];
			...
			<div class="profile"><label><select class="state <?php
...
<div class="profile"><label><input type="password" name="password" class="txtb <?php
...
echo $_SESSION['password'];
			...
			<div class="profile"><label><input type="password" name="confirmpassword" class="txtb <?php
    if( !isset($_SESSION['password']) && isset($_SESSION['error']) )
echo 'error';
...
echo $_SESSION['password'];
			...
			?>" placeholder="Confirm Password" /></label></div>
